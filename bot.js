...
bot.on("message", async message => {
    ...
    if (message.content === `אני אוהב אותך`) {
        message.channel.sendMessage('הכי בעולם:)' )  
        message.channel.send('<@390246455052337152>' + ' :heart: :sparkling_heart: :yellow_heart: :blue_heart: ')

    }
    if (message.content === `אני אוהבת אותך`) {
        message.channel.sendMessage('הכי בעולם:)' )  
        message.channel.send('<@336527823571517443>' + ' :heart: :sparkling_heart: :yellow_heart: :blue_heart: ')
    ...
    if (message.content === `מחמאות למיקו`) {
...
bot.on("message", function (message) {
    ...
    switch (arguments[0].toLowerCase()) {
        ...
        case "help":
        message.channel.send(`the prefix is '${prefix}' And the current commands are:\n -hello \n -help \n -miss \n -lam \n -ping \n -cute \n -youarecute \n -ily \n -ilym \n -ilyem \n -sad \n -die \n -both \n -ty \n -bea \n -s \n -gn \n -gm \n -sry \n -miko \n -nh \n -amazing \n ------AND THE BEST COMMANDS------ \n לבבות \n LIES \n אחיקור \n אני אוהבת את \n מיקו תביאי לי לב \n נהוראי הוא חמוד \n מיקו היא חמודה \n מחמאות \n מחמאות למיקו \n אני אוהבת אותך \n אני אוהב אותך \n ------MIKO SPECIAL COMMANDS------ \n -adorable \n -wth \n -lm \n -lmiko \n -scare \n -nc \n ------MISTAKE SPECIAL COMMANDS------ \n -heart \n -ith \n -omg \n -now \n -30 \n ------ROMANTICS PHOTOS------ \n -photo \n -cutie \n ------MUSIC COMMANDS------ \n -play (Link is Needed) \n -skip \n -stop`);
        message.author.sendMessage(`ReMeMbEr \n the prefix is '${prefix}' And the current commands are:\n -hello \n -help \n -miss \n -lam \n -ping \n -cute \n -youarecute \n -ily \n -ilym \n -ilyem \n -sad \n -die \n -both \n -ty \n -bea \n -s \n -gn \n -gm \n -sry \n -miko \n -nh \n -amazing \n ------AND THE BEST COMMANDS------ \n לבבות \n LIES \n אחיקור \n אני אוהבת את \n מיקו תביאי לי לב \n נהוראי הוא חמוד \n מיקו היא חמודה \n מחמאות \n מחמאות למיקו \n אני אוהבת אותך \n אני אוהב אותך \n ------MIKO SPECIAL COMMANDS------ \n -adorable \n -wth \n -lm \n -lmiko \n -scare \n -nc \n ------MISTAKE SPECIAL COMMANDS------ \n -heart \n -ith \n -omg \n -now \n -30 \n ------ROMANTICS PHOTOS------ \n -photo \n -cutie \n ------MUSIC COMMANDS------ \n -play (Link is Needed) \n -skip \n -stop`)
        break;
